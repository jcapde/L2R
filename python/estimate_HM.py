...
if __name__ == "__main__":
    ...
    print("Harmonic Mean Sampling")
    hm = pfa.inference_ds("HM", opts, y_D[docs,:], Phi, r, p)

    with open('python/output/HM_'+dataset+"_"+str(counter)+"Ntest_"+str(W)+'W_'+str(K)+'K.json', 'w') as outfile:

...
if __name__ == "__main__":
    ...
    print("Exact Marginal Document Likelihood")
    ext = pfa.inference_ds("Exact", opts, y_D[docs,:], Phi, r, p)
    
    with open('python/output/Exact_'+dataset+"_"+str(counter)+"Ntest_"+str(W)+'W_'+str(K)+'K.json', 'w') as outfile:
        json.dump(ext, outfile)
